...
- Upon logging in (yet to be implemented) the user will be prompted to choose a study
...
- After loading this study, we then have to request the client choose a series (yet to be implemented)
- we then must display it (this will involve changing the current implementation of file loading only slightly--it will still be from a local address)
...
search--halfway implemented, searching studies is done. We'll be searching series locally, I believe
retrieve
