...
app.post("/retrieve", async (req, res) => {
  ...
  //now that we know the files are there
...
app.post("/saveSeg", (req, res)=>{
  //FIXME: I'm slightly worried that it might be attempted to be parsed as a JSON file, but I don't think that's correct
  ...
  fs.writeFile(blob.name, blob.buffer, (err) => {
    if (err) {
